...
class ResumeShortcode {
    ...
    public function render() {
        ...
        function createElement($dom, $tag, $class, $text = null, $attributes = []) {
            ...
            if ($section->content->type === 'nested') {
                ...
                foreach ($section->content->nestedSections as $item) {
                    ...
                    foreach ($item->details as $detail) {
                        ...
                        $detail_classes = "spenpo-resume-section-content-nested-item-text-$detail->id";
                        ...
                        if (isset($detail->title)) {
                            $section_content_nested_item_content = createElement($dom, 'div', $detail_classes);
                            ...
                            $section_content_nested_item_content = createElement($dom, 'p', $detail_classes, $detail->text);
                        }
