CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}spcv_resume_sections` (
...
CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}spcv_resume_section_items` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}spcv_resume_section_text_content` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `section_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}spcv_resume_nested_sections` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `section_id` int(11) NOT NULL,
    `title` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}spcv_resume_nested_section_details` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
